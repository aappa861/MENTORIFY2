...
function login() {
  ...
  <form onSubmit={handleSubmit} className="bg-white p-8 rounded-lg shadow-xl w-full max-w-sm">
    <h2 className="text-3xl font-bold text-center mb-6 text-[#6ad1ed]">Login</h2>
    ...
    <div className="mb-4">
      ...
      <input
        ...
        required
        className="shadow appearance-none border border-[#e6a05a] rounded w-full py-2 px-3 text-gray-700 focus:outline-none focus:border-[#BBDCE5]"
      />
    </div>
    ...
    <div className="mb-6">
      ...
      <input
        ...
        onChange={handleChange}
        required
        className="shadow appearance-none border border-[#e6a05a] rounded w-full py-2 px-3 text-gray-700 mb-3 focus:outline-none focus:border-[#BBDCE5]"
      />
    </div>
    ...
    <Link to={"/signup"} className="text-[#6ad1ed] py-4">Don't have Account </Link>
  </form>
</div>
